...
jQuery(document).ready(function ($) {
  alert('Funciona este js a nivel módulo');
});
;
/*!
 * jQuery Form Plugin
...
jQuery(document).ready(function ($) {
  alert('Javascript lanzado a nivel global, para todo del sitio');
});
;
/**
* DO NOT EDIT THIS FILE.
